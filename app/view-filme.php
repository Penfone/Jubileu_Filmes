...
?>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="./_cad-favoritosbd.php"  method="POST" enctype="multipart/form-data">
            ...
            <div class="divisor">
                ...
                <div class="auxDivisor">
                    ...
                    <div class="container coluna-2">
                            ...
                            <input type="text" class="form-control" id="titulo" name="titulo" value="<?=$resultado['titulo'];?>" readonly>
                            <br>
                            </div>

                            <div>
                            <label for="diretor">Diretor</label>
                            <input type="text" class="form-control" id="diretor" name="diretor" placeholder="Nome do diretor"  value="<?=$resultado['diretor'];?>" readonly>
                            <br>
                            </div>
                                ...
                                <div class="divisor">
                                    ...
                                    <div class="auxDivisor">
                                        ...
                                        <div class="coluna">
                                            ...
                                            <input type="number" class="form-control" step="0.1" min="0" max="10" id="nota" name="nota" placeholder="de 0 a 10" value="<?=$resultado['nota'];?>" readonly> 
                                        </div>
                                        ...
                                        <input type="year" class="form-control date" id="ano" name="ano" placeholder="Ano" value="<?=$resultado['ano'];?>" readonly>
                                        <br>
                                        </div>
                                        
                                        <div class="coluna">
                                        <label for="classInd">Classificação indicativa</label>
                                                <select name="fe" id="fe" disabled>
                                        ...
                                        <input type="time" class="form-control time" id="duracao" name="duracao" value="<?=$resultado['duracao'];?>" readonly>
                                        </div>
                            ...
                            <div class="container">    
                                <div class="auxDivisor">
                                        ...
                                        <div class="coluna">
                                            ...
                                            <select class="larg" name="gen1" id="cat" disabled>
                                            <option value="0" <?=$ativo=$resultado["gen1"]=="0"?" selected":"";?> ></option>
                                                ...
                                                <option value="5" <?=$ativo=$resultado["gen1"]=="5"?" selected":"";?> >Crime</option>
                                                <option value="6" <?=$ativo=$resultado["gen1"]=="6"?" selected":"";?> >Documentário</option>
                                        ...
                                        <div class="coluna">
                                            ...
                                            <select class="larg" name="gen2" id="cat" disabled>
                                            <option value="0" <?=$ativo=$resultado["gen2"]=="0"?" selected":"";?> ></option>
                                                ...
                                                <option value="5" <?=$ativo=$resultado["gen2"]=="5"?" selected":"";?> >Crime</option>
                                                <option value="6" <?=$ativo=$resultado["gen2"]=="6"?" selected":"";?> >Documentário</option>
                                        ...
                                        <div class="coluna">
                                            ...
                                            <select class="larg" name="gen3" id="cat" disabled>
                                            <option value="0" <?=$ativo=$resultado["gen3"]=="0"?" selected":"";?> ></option>
                                                ...
                                                <option value="5" <?=$ativo=$resultado["gen3"]=="5"?" selected":"";?> >Crime</option>
                                                <option value="6" <?=$ativo=$resultado["gen3"]=="6"?" selected":"";?> >Documentário</option>
                                        ...
                                        <div class="coluna">
                                            ...
                                            <select class="larg" name="gen4" id="cat" disabled>
                                            <option value="0" <?=$ativo=$resultado["gen4"]=="0"?" selected":"";?> ></option>
                                                ...
                                                <option value="5" <?=$ativo=$resultado["gen4"]=="5"?" selected":"";?> >Crime</option>
                                                <option value="6" <?=$ativo=$resultado["gen4"]=="6"?" selected":"";?> >Documentário</option>
                            ...
                            <textarea class="form-control" id="sinopse" name="sinopse" placeholder="Sinopse" rows="5" cols="100" maxlength="1500" readonly><?=$resultado['sinopse'];?></textarea>
                            </div>
                        ...
                        <button class="btn btn-danger" type="submit">Favotitar</button>
                        <?php }?>
